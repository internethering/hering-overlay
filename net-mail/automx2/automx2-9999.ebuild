...
DESCRIPTION="Mail User Agent (email client) configuration made easy - fixed version"
HOMEPAGE="https://github.com/internethering/automx2"
#SRC_URI="https://github.com/rseichter/automx2/archive/${PV}.tar.gz -> ${P}.tar.gz"
EGIT_REPO_URI="https://github.com/internethering/automx2.git"
...
python_install_all() {
	...
	if use systemd ; then
		systemd_dounit "${FILESDIR}"/automx2.service
	else
