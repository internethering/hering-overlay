...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="opendmarc pure-ftpd spamassassin geoip clamav-unofficial-sigs amavisd-milter rmilter dhparams"
...
src_install() {
	...
	if use rmilter ; then
		systemd_dounit rmilter.service
		systemd_dotmpfilesd rmilter.tmpfiles.conf
	fi
